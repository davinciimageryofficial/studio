...
export const SearchAIOutputSchema = z.object({
  ...
  destination: z.string().nullable().optional().describe('The page to navigate to, if requested by the user. Should be one of "dashboard", "feed", "messages", "discover", "workspaces", "workmate-radar", "news", "courses", "billing", "profile", "settings".'),
});
